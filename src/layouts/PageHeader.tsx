        ...
        <div className="flex gap-10 lg:gap-20 justify-between pt-2 mb-6 mx-4">
            ...
            <div>
                <form className={` gap-4 flex-grow justify-center ${showFullWidthSearch ? "flex" : "hidden md:flex"}`}>
                    {showFullWidthSearch && <Button onClick={() => setShowFullWidthSearch(false)} size="icon" variant="ghost" className="flex-shrink-0">
                        <ArrowLeft />
                    </Button>}
                    <div className="flex flex-grow w-[340px] lg:w-[600px]">
